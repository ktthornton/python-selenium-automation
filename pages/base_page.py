...
class Page:
    ...
    def switch_to_new_window(self):
        ...
        all_windows = self.driver.window_handles  # window handles puts windows in a list
        print(all_windows)
        print(f'Switching to {all_windows[1]}')
        self.driver.switch_to.window(all_windows[1])  # we want the 2nd window that opened, so index 1
